import './load-env';
import { clearTickets, contactCountForOrder, insertTicket } from '../lib/db';
import { evaluateEscalation } from '../lib/escalation';
import { findOrder } from '../lib/orders';
import { retrieve } from '../lib/retrieval';
import { escalationNotice } from '../lib/triage';
...
function seed() {
  ...
  console.log(
    `Seeded ${FIXTURES.length} cases: ${escalated} escalated, ${FIXTURES.length - escalated} auto-answered.`,
  );
}
